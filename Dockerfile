...
#ENV componentName "CoreTrustManager"
...
ADD build/libs/CoreTrustManager-0.1.0-SNAPSHOT-run.jar coretm.jar
ENV JAVA_OPTS="-Xms512m -Xmx512m"
ENV APP_PROPS="--external.config=/src/main/resources/bootstrap.properties"
ENTRYPOINT [ "sh", "-c", "java $JAVA_OPTS -jar /coretm.jar $APP_PROPS" ]